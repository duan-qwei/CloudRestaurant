...
// InsertUser 添加一个用户
func (UserManagerController *UserManagerController) InsertUser(c *gin.Context) {
...
func (UserManagerController *UserManagerController) GetUerInfoById(c *gin.Context) {
...
func (UserManagerController *UserManagerController) DeleteUserById(c *gin.Context) {
	paramId := c.Param("id")
	if paramId == "" {
...
// Update 更新用户
func (UserManagerController *UserManagerController) Update(c *gin.Context) {
